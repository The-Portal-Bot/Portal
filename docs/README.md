...
| `announcement`     | _creates a new or sets the current channel as announcement_      | _@channel\_name \| @category\_name_  | admin, portal-admins                                  | admin-role/s    |
...
| `force`            | _clones current channel in order to force-update name_           | _none_                               | admin, portal-admins, admin-roles                     | 2 user          |
...
| `joke`             | _replies with a joke_                                            | _@category_                          | everyone                                              | 1 user          |
...
| `save`             | _saves current state of server_                                  | _none_                               | admin, portal-admins, admin-roles                     | 5 server        |
...
| `state`            | _returns the current state of portal_                            | _@channel\_name \| @category\_name_  | admin, portal-admins                                  | admin-role/s    |
